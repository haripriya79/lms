...
.pp{
  ...
  <?php include('includes/header.php');?>
       ...
       <?php include('includes/sidebar.php');?>
            <main class="mn-inner">
                <div class="row">
                    <h3 class="fb">Welcome to Leave Mangement System</h3>
                    <h5 class="fb">Applying Leaves Made Easy</h5>
                </div>
                <div class="row">
                    <div class="col s6">
                        <p class="pp"><b>If you are logging in for the first time, please change your password!</b></p>
                        <ol  type="*">
                            <li class="fs">
                                Apply Leaves from the Leaves Section.
                            </li>
                            <li  class="fs">
                                Check Your Leave History in the Leave History Section.
                            </li>
                            <li  class="fs">
                                You can change your details in the My Profile Section
                            </li>
                        </ol>
                    </div>
                    <div class="col s6">
