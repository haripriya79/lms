...
<body>
    ...
    <main class="mn-inner">
        <div class="middle-content">
            <div class="row no-m-t no-m-b fb">
                <h4>
                    <center>
                        Leave Dashboard
                    </center>
                ...
                <div class="col s12 m12 l4">
                    <div class="card stats-card">
                        <div class="card-content">
                            ...
                            <span class="card-title fs">Total Regd Employee</span>
...
?>
                                ...
                                <span class="counter fb"><?php echo htmlentities($empcount);?></span></span>
                        </div>
                ...
                <div class="col s12 m12 l4">
                    <div class="card stats-card">
                        <div class="card-content">
                            ...
                            <span class="card-title fs">Listed Pending Leaves </span>
                            <?php
                            try{
                            $status=0;
$sql = "SELECT id from tblleaves where tblleaves.Status=:status ";
$query = $dbh -> prepare($sql);
...
?>
                            <span class="stats-counter fb"><span
                ...
                <div class="col s12 m12 l4">
                    <div class="card stats-card">
                        <div class="card-content">
                            <span class="card-title fs">Listed leave Type</span>
                            <?php
                ...
                <div class="col s12 m12 l12">
                    <div class="card invoices-card">
                        <div class="card-content">
                            ...
                            <span class="card-title fs">Latest Leave Applications</span>
