...
{
    try{
        $sql1="INSERT INTO tbtotalleaves(empid) VALUES(:empid)";
$query1 = $dbh->prepare($sql1);
$query1->bindParam(':empid',$lastInsertId,PDO::PARAM_STR);
$query1->execute();
...
<div class="input-field col m6 s12 fs">
